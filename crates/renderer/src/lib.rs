...
use renderer_schema::{Color, EffectV1, FillV1, MAX_CANVAS_DIMENSION, NodeKindV1, SceneV1};
use std::{
    collections::HashMap,
    fs,
    fs::File,
...
mod tests {
    use super::*;
    use renderer_schema::{CanvasV1, GradientV1, KeyframeV1, NodeV1, SCENE_VERSION_V1};
